...
def index(request):
    receitas = Receita.objects.order_by('-date_receita').filter(publicada=True).all()
...
def cria_receita(request):
    if request.method == 'POST':
        ...
        mode_preparo = request.POST['mode_preparo']
        ...
        ingredientes=ingredientes, mode_preparo=mode_preparo,
...
def atualiza_receita(request):
    if request.method == 'POST':
        ...
        r.mode_preparo = request.POST['mode_preparo']
